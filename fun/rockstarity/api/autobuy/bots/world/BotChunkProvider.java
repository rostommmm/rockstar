...
public class BotChunkProvider extends AbstractChunkProvider
{
	protected static Minecraft mc = Minecraft.getInstance(); 
    private static final Logger LOGGER = LogManager.getLogger();
    private final Chunk empty;
    private final WorldLightManager lightManager;
    private volatile BotChunkProvider.ChunkArray array;
    private final BotWorld world;

    public BotChunkProvider(BotWorld clientWorldIn, int viewDistance)
    {
        ...
        this.array = new BotChunkProvider.ChunkArray(adjustViewDistance(viewDistance));
    }
    ...
    public void setViewDistance(int viewDistance)
    {
        ...
        if (i != j)
        {
        	BotChunkProvider.ChunkArray clientchunkprovider$chunkarray = new BotChunkProvider.ChunkArray(j);
    ...
    {
        mc.worldRenderer.markForRerender(pos.getSectionX(), pos.getSectionY(), pos.getSectionZ());
    }
    ...
    final class ChunkArray
    {
        ...
        protected void replace(int chunkIndex, @Nullable Chunk chunkIn)
        {
            ...
            {
                --this.loaded;
                BotChunkProvider.this.world.onChunkUnloaded(chunk);
            }
        ...
        protected Chunk unload(int chunkIndex, Chunk chunkIn, @Nullable Chunk replaceWith)
        {
            ...
            BotChunkProvider.this.world.onChunkUnloaded(chunkIn);
            return chunkIn;
        }
