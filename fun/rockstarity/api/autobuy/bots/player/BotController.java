...
public class BotController
{
    ...
    public void tick()
    {
        ...
        if (this.connection.getBotNetworkManager().isChannelOpen())
        {
            this.connection.getBotNetworkManager().tick();
        }
        else
        {
            this.connection.getBotNetworkManager().handleDisconnection();
        }
    ...
    {
    	this.bot = new BotPlayer(this.mc, p_239167_1_, this.connection, p_239167_2_, p_239167_3_, p_239167_4_, p_239167_5_);
        return this.bot;
    }
    ...
    {
    	if (targetEntity instanceof LivingEntity living && new EventAttack(living).hook().isCancel()) return;
