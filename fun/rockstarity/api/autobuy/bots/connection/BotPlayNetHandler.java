...
import fun.rockstarity.api.autobuy.bots.world.BotChunkProvider;
import fun.rockstarity.api.autobuy.bots.world.BotWorld;
import fun.rockstarity.api.autobuy.fake.ScreenTransformer;
...
public class BotPlayNetHandler implements IClientPlayNetHandler, IAccess
{
     ...
     */
    public final BotNetworkManager netManager;
    ...
    private final BotSuggestionProvider clientSuggestionProvider;
    ...
    public BotPlayNetHandler(Minecraft mcIn, Screen previousGuiScreen, BotNetworkManager networkManager, GameProfile profileIn)
    {
        this.client = mcIn;
        this.guiScreenServer = previousGuiScreen;
        this.netManager = networkManager;
        this.profile = profileIn;
        this.advancementManager = new ClientAdvancementManager(Minecraft.getInstance());
        this.clientSuggestionProvider = new BotSuggestionProvider(this, Minecraft.getInstance());
        this.movementInput = new MovementInput(){

            @Override
            public void tickMovement(boolean p_225607_1_) {
            	this.forwardKeyDown = GLFW.glfwGetKey(mc.getMainWindow().getHandle(), GLFW.GLFW_KEY_UP) == GLFW.GLFW_PRESS && mc.currentScreen == null || bot != null && bot.FORWARD;
                this.backKeyDown = GLFW.glfwGetKey(mc.getMainWindow().getHandle(), GLFW.GLFW_KEY_DOWN) == GLFW.GLFW_PRESS && mc.currentScreen == null || bot != null && bot.BACKWARD;
                this.leftKeyDown = GLFW.glfwGetKey(mc.getMainWindow().getHandle(), GLFW.GLFW_KEY_LEFT) == GLFW.GLFW_PRESS && mc.currentScreen == null || bot != null && bot.LEFT;
                this.rightKeyDown = GLFW.glfwGetKey(mc.getMainWindow().getHandle(), GLFW.GLFW_KEY_RIGHT) == GLFW.GLFW_PRESS && mc.currentScreen == null || bot != null && bot.RIGHT;
                ...
                this.jump = bot != null && bot.JUMP;
                this.sneaking = bot != null && bot.SNEAK;
    ...
    public BotSuggestionProvider getSuggestionProvider()
    {
    ...
    {
    	try {
            botController = new BotController(this.client, this);
            ...
            this.world = new BotWorld(this, clientworld$clientworldinfo, registrykey, dimensiontype, this.viewDistance, this.client::getProfiler, this.client.worldRenderer, flag, packetIn.getHashedSeed());
            ...
            //displayGuiScreen(new DownloadTerrainScreen());
            ...
            this.client.getGameSettings().sendSettingsToServer();
            ...
            for (Bot bot : rock.getBotsHandler().getBots()) {
            	if (bot.getName() == rock.getBotsHandler().getLastName()) canPut = false;
            }
            
            //if (canPut)
            	rock.getBotsHandler().getBots().add(new Bot(rock.getBotsHandler().getLastName(), netManager, botController, this.bot, world));       
    ...
    private void loadWorld(BotWorld world2) {
    	this.world = world2;
        this.bot = new BotPlayer(this);
        this.bot.preparePlayerToSpawn();
        this.world.addEntity(this.bot);
        this.botController.setPlayerCapabilities(this.bot);
        this.bot.movementInput = this.movementInput;
        this.world.setBot(this.bot);
	}
    ...
    public void handlePlayerPosLook(SPlayerPositionLookPacket packetIn)
    {
        ...
        BotPlayer playerentity = this.bot;
    ...
    public void processChunkUnload(SUnloadChunkPacket packetIn)
    {
        ...
        int i = packetIn.getX();
        int j = packetIn.getZ();
        BotChunkProvider clientchunkprovider = this.world.getChunkProvider();
    ...
    {
    	Chat.debug("РћС‚РєРѕРЅРµРєС‚РёР»Рѕ");
    ...
    {
    	Chat.debug("РћС‚РєРѕРЅРµРєС‚РёР»Рѕ: " + reason.getString());
        ...
        if (this.guiScreenServer != null)
        {
            ...
            {
                displayGuiScreen(new DisconnectedScreen(this.guiScreenServer, field_243491_b, reason));
            }
        }
        else
        {
            displayGuiScreen(new DisconnectedScreen(new MultiplayerScreen(new MainMenuScreen()), field_243491_b, reason));
        }
        */
    }
    ...
    public void sendPacketSilent(IPacket<?> packetIn)
    {
    ...
    public void handleChat(SChatPacket packetIn)
    {
    	...
    	if (msg.contains("/login")) {
    		//bot.sendChatMessage("/l 123123");
    		
    		netManager.sendPacket(new CChatMessagePacket("/l 123123"));
    	}
    }
        ...
        else
        {
            ...
            for (int i : packetIn.getPassengerIds())
            {
                ...
                if (entity1 != null)
                {
                    ...
                    {
                        //this.client.ingameGUI.setOverlayMessage(new TranslationTextComponent("mount.onboard", this.client.getGameSettings().keyBindSneak.func_238171_j_()), false);
                    }
                }
            }
        }
    ...
    public void handleRespawn(SRespawnPacket packetIn)
    {
        ...
        if (registrykey != clientplayerentity.world.getDimensionKey())
        {
            ...
            this.field_239161_g_ = clientworld$clientworldinfo;
            this.world = new BotWorld(this, clientworld$clientworldinfo, registrykey, dimensiontype, this.viewDistance, this.client::getProfiler, this.worldRenderer, flag, packetIn.getHashedSeed());
        ...
        BotPlayer clientplayerentity1 = botController.func_239167_a_(this.world, clientplayerentity.getStats(), clientplayerentity.getRecipeBook(), clientplayerentity.isSneaking(), clientplayerentity.isSprinting());
        clientplayerentity1.setEntityId(i);
        bot = clientplayerentity1;
        ...
        clientplayerentity1.movementInput = new MovementInputFromOptions(this.client.getGameSettings());
    ...
    public void handleOpenHorseWindow(SOpenHorseWindowPacket packetIn)
    {
        ...
        if (entity instanceof AbstractHorseEntity)
        {
            ...
            displayGuiScreen(new HorseInventoryScreen(horseinventorycontainer, clientplayerentity.inventory, abstracthorseentity));
        }
    }

    public void handleOpenWindowPacket(SOpenWindowPacket packetIn)
    {
        rock.getBotsHandler().setLastBot(bot);
    	Screen screen = ScreenManager.createScreen(packetIn.getContainerType(), this.client, packetIn.getWindowId(), packetIn.getTitle());
    	//ScreenTransformer.transform(screen);
    }

    public void displayGuiScreen(Screen screen) {
    	bot.currentScreen = screen;
    }
    ...
    public void handleChangeGameState(SChangeGameStatePacket packetIn)
    {
        ...
        else if (schangegamestatepacket$state == SChangeGameStatePacket.field_241768_e_)
        {
            ...
            {
                displayGuiScreen(new WinGameScreen(true, () ->
                {
                    this.bot.connection.sendPacket(new CClientStatusPacket(CClientStatusPacket.State.PERFORM_RESPAWN));
                }));
            }
        ...
        {
            GameSettings gamesettings = this.client.getGameSettings();
            if (f == 101.0F)
            {
    ...
    {
    	//if (mc.getNetworkManager().getNetHandler() instanceof ClientPlayNetHandler play) {
    	//	play.handleMaps(packetIn);
    	//}
    	/*
    ...
    public void handleCombatEvent(SCombatPacket packetIn)
    {
        ...
        if (packetIn.eventType == SCombatPacket.Event.ENTITY_DIED)
        {
            ...
            if (entity == this.bot)
            {
                ...
                {
                 //   displayGuiScreen(new DeathScreen(packetIn.deathMessage, this.world.getWorldInfo().isHardcore()));
                }
                else
                {
                  //  this.bot.respawnPlayer();
        ...
        if (this.validateResourcePackUrl(s))
        {
            ...
            else
            {
                ...
                else
                {
                    this.client.execute(() ->
                    {
                        displayGuiScreen(new ConfirmScreen((p_217274_3_) -> {
    ...
    public void handleOpenBookPacket(SOpenBookWindowPacket packetIn)
    {
        ...
        {
            displayGuiScreen(new ReadBookScreen(new ReadBookScreen.WrittenBookInfo(itemstack)));
        }
    }
    ...
    public void handleAcknowledgePlayerDigging(SPlayerDiggingPacket packetIn)
    {
        ...
        botController.acknowledgePlayerDiggingReceived(this.world, packetIn.getPosition(), packetIn.getBlockState(), packetIn.getAction(), packetIn.wasSuccessful());
    }
	...
	public BotNetworkManager getBotNetworkManager() {
