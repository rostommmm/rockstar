...
public class StrafeMovement implements IAccess {
    ...
    public double calculateSpeed(final EventMotionMove move, boolean damageBoost, boolean hasTime, boolean autoJump,
                                 float damageSpeed) {
    ...
    private float getFrictionFactor(final ClientPlayerEntity contextPlayer, final EventMotionMove move) {
