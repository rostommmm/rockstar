...
@UtilityClass
public class MoveUtils implements IAccess {
    ...
    public void setMotion(final double speed) {
        ...
        mc.player.setMotion(-Math.sin(yaw) * speed, mc.player.getMotion().y, Math.cos(yaw) * speed);
    }
    ...
    public static class MoveEvent {
        public static void setMoveMotion(final EventMotionMove move, final double motion) {
