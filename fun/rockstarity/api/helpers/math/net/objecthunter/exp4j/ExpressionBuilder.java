...
public class ExpressionBuilder {
    ...
    /**
     * Add a {@link net.FilterProcessor.exp4j.function.Function} implementation available for use in the expression
     *
     * @param function the custom {@link net.FilterProcessor.exp4j.function.Function} implementation that should be available for use in the expression.
    ...
    /**
     * Add multiple {@link net.FilterProcessor.exp4j.function.Function} implementations available for use in the expression
     *
     * @param functions the custom {@link net.FilterProcessor.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
     ...
     * Add multiple {@link net.FilterProcessor.exp4j.function.Function} implementations available for use in the expression
     *
     * @param functions A {@link java.util.List} of custom {@link net.FilterProcessor.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
