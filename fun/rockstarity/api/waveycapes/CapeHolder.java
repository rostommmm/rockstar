...
import fun.rockstarity.api.waveycapes.math.Vector2;
...
public interface CapeHolder {
	 StickSimulation getSimulation();
	    ...
	    default void simulate(AbstractClientPlayerEntity abstractClientPlayer) {
	        ...
	        final double o = MathHelper.sin(n * 0.017453212f);
	        final double p = -MathHelper.cos(n * 0.017453212f);
	        ...
	        if (abstractClientPlayer.canSwim()) {
	            ...
	            simulation.setGravity((float) WaveyCapesBase.config.gravity - 11);
	        }
