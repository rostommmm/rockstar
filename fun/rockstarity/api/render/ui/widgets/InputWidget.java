...
public class InputWidget extends Widget implements IRenderable, IGuiEventListener, IAccess
{
    ...
    public InputWidget(FontSize p_i232260_1_, int p_i232260_2_, int p_i232260_3_, int p_i232260_4_, int p_i232260_5_, ITextComponent p_i232260_6_)
    {
        this(p_i232260_1_, p_i232260_2_, p_i232260_3_, p_i232260_4_, p_i232260_5_, (InputWidget)null, p_i232260_6_);
    }
    
    public InputWidget(FontSize p_i232260_1_, int p_i232260_2_, int p_i232260_3_, int p_i232260_4_, int p_i232260_5_, ITextComponent p_i232260_6_, boolean bg)
    {
        this(p_i232260_1_, p_i232260_2_, p_i232260_3_, p_i232260_4_, p_i232260_5_, (InputWidget)null, p_i232260_6_);
        this.bg = bg;
    }

    public InputWidget(FontSize p_i232259_1_, int p_i232259_2_, int p_i232259_3_, int p_i232259_4_, int p_i232259_5_, @Nullable InputWidget p_i232259_6_, ITextComponent p_i232259_7_)
    {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button)
    {
        ...
        else
        {
            ...
            if (this.isFocused() && flag && button == 0)
            {
                ...
                for (int ch = 0; ch < this.text.length(); ch++)
                {
                	float distance = (float) Math.abs(fontRenderer.getWidth(this.text.substring(ch)) - (mouseX - 5 - this.x));
                	
                	if (distance < closestDistance) {
                		pos = this.text.substring(ch).length();
