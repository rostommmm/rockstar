...
public class WorldCustomList extends ExtendedList<WorldCustomList.Entry>
{
    ...
    private final SingleScreen worldSelection;
    @Nullable
    private List<WorldSummary> field_212331_y;

    public WorldCustomList(SingleScreen p_i49846_1_, Minecraft p_i49846_2_, int p_i49846_3_, int p_i49846_4_, int p_i49846_5_, int p_i49846_6_, int p_i49846_7_, @Nullable WorldCustomList p_i49846_9_)
    {
    ...
    public void setSelected(@Nullable WorldCustomList.Entry entry)
    {
    ...
    public Optional<WorldCustomList.Entry> func_214376_a()
    {
        return Optional.ofNullable(this.getSelected());
    }

    public SingleScreen getGuiWorldSelection()
    {
        return this.worldSelection;
    }

    public final class Entry extends ExtendedList.AbstractListEntry<WorldCustomList.Entry> implements AutoCloseable
    {
        private final Minecraft field_214449_b;
        private final SingleScreen field_214450_c;
        ...
        public Entry(WorldCustomList p_i242066_2_, WorldSummary p_i242066_3_)
        {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
        {
            ...
            String s1 = this.field_214451_d.getFileName() + " (" + WorldCustomList.field_214377_b.format(new Date(this.field_214451_d.getLastTimePlayed())) + ")";
            ...
            bold.get(17).draw(p_230432_1_, s, (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 1), rock.getThemes().getTextFirstColor().alpha(p_230432_10_));
            bold.get(17).draw(p_230432_1_, s1, (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 9 + 1), rock.getThemes().getTextSecondColor().alpha(p_230432_10_));
            bold.get(17).draw(p_230432_1_, itextcomponent.getString(), (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 9 + 9 + 1), rock.getThemes().getTextSecondColor().alpha(p_230432_10_));
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            this.field_214449_b.getTextureManager().bindTexture(this.field_214454_g != null ? this.field_214452_e : WorldCustomList.field_214378_c);
            RenderSystem.enableBlend();
            Round.drawTextured(p_230432_1_, new Rect(p_230432_4_, p_230432_3_, 32, 32), 3, p_230432_10_);
            RenderSystem.disableBlend();

            if (this.field_214449_b.getGameSettings().touchscreen || p_230432_9_)
            {
                this.field_214449_b.getTextureManager().bindTexture(WorldCustomList.field_214379_d);
                ...
                if (this.field_214451_d.isLocked())
                {
                    ...
                    if (flag)
                    {
                        this.field_214450_c.func_239026_b_(this.field_214449_b.fontRenderer.trimStringToWidth(WorldCustomList.field_243466_v, 175));
                    }
                }
                else if (this.field_214451_d.markVersionInList())
                {
                    ...
                    if (this.field_214451_d.askToOpenWorld())
                    {
                        ...
                        if (flag)
                        {
                            this.field_214450_c.func_239026_b_(ImmutableList.of(WorldCustomList.field_243462_r.func_241878_f(), WorldCustomList.field_243463_s.func_241878_f()));
                        }
                    }
                    else if (!SharedConstants.getVersion().isStable())
                    {
                        ...
                        if (flag)
                        {
                            this.field_214450_c.func_239026_b_(ImmutableList.of(WorldCustomList.field_243464_t.func_241878_f(), WorldCustomList.field_243465_u.func_241878_f()));
                        }
                    }
                }
                else
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int button)
        {
            ...
            {
                WorldCustomList.this.setSelected(this);
                this.field_214450_c.func_214324_a(WorldCustomList.this.func_214376_a().isPresent());

                if (mouseX - (double)WorldCustomList.this.getRowLeft() <= 32.0D)
                {
                    this.func_214438_a();
                    return true;
                }
                    ...
                    this.field_214449_b.displayGuiScreen(new ConfirmBackupScreen(this.field_214450_c, (p_214436_1_, p_214436_2_) ->
                    {
                        if (p_214436_1_)
                        {
                            ...
                            catch (IOException ioexception)
                            {
                                ...
                                WorldCustomList.LOGGER.error("Failed to backup level {}", s, ioexception);
                            }
                        }
                ...
                else if (this.field_214451_d.askToOpenWorld())
                {
                    this.field_214449_b.displayGuiScreen(new ConfirmScreen((p_214434_1_) ->
                    {
                        if (p_214434_1_)
                        {
                            ...
                            {
                                WorldCustomList.LOGGER.error("Failure to open 'future world'", (Throwable)exception);
            ...
            this.field_214449_b.displayGuiScreen(new ConfirmScreen((p_214440_1_) ->
            {
                if (p_214440_1_)
                {
                    ...
                    catch (IOException ioexception)
                    {
                        ...
                        WorldCustomList.LOGGER.error("Failed to delete world {}", s, ioexception);
                    }
        ...
        public void func_214444_c()
        {
            ...
            try
            {
                ...
                this.field_214449_b.displayGuiScreen(new EditWorldScreen((p_239096_3_) ->
                {
                    ...
                    {
                        WorldCustomList.LOGGER.error("Failed to unlock level {}", s, ioexception1);
                    }
            ...
            {
                SystemToast.func_238535_a_(this.field_214449_b, s);
                WorldCustomList.LOGGER.error("Failed to access level {}", s, ioexception);
            }
        }
        ...
        public void func_214445_d()
        {
            ...
            {
                WorldCustomList.LOGGER.error("Unable to recreate world", (Throwable)exception);
                this.field_214449_b.displayGuiScreen(new AlertScreen(() ->
                {
                    this.field_214449_b.displayGuiScreen(this.field_214450_c);
        ...
        private DynamicTexture func_214446_f()
        {
            ...
            if (flag)
            {
                ...
                {
                    WorldCustomList.LOGGER.error("Invalid icon for world {}", this.field_214451_d.getFileName(), throwable);
                    this.field_214453_f = null;
                    return null;
                }
            }
